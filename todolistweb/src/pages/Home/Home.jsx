...
export const Home = ({tasksArray, setTasksArray, outputArray, setOutputArray}) => {
        ...
        <div className='homeWidget'>
             ...
             <div className='tasksContainer'> 
                 {outputArray.map((item)=>(
                  //  <p>{item.taskName}</p>
                  <TaskWidget id={item.id} taskName={item.taskName} taskDesc={item.taskDescription} progress={item.progress} tasksArray={tasksArray} setTasksArray={setTasksArray} setOutputArray={setOutputArray}/>
                 ))}
             </div>
            
             {PopupClicked && <PopUpComp tasksArray={tasksArray} setTasksArray={setTasksArray} setPopupClicked={setPopupClicked} setOutputArray={setOutputArray}/>}
